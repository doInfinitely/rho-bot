  ...
  return (
    <footer className="border-t border-neutral-800/60 bg-neutral-950">
      <div className="mx-auto max-w-6xl px-6 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="mt-3 text-sm text-neutral-500 leading-relaxed">
              Autonomous desktop agent powered by hierarchical goal induction.
            </p>
          </div>

          {/* Product */}
          <div>
            <h4 className="text-sm font-semibold text-neutral-300 mb-3">Product</h4>
        ...
        <div className="mt-10 pt-8 border-t border-neutral-800/60 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-xs text-neutral-600">
            &copy; {new Date().getFullYear()} rho-bot. All rights reserved.
          </p>
          <div className="flex items-center gap-6">
            <a href="https://github.com" className="text-neutral-600 hover:text-neutral-400 transition-colors">
            ...
            <a href="https://twitter.com" className="text-neutral-600 hover:text-neutral-400 transition-colors">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
